 ...
 * 
 * <p>
 * This class is a model that represents the <code>Player</code> table in the
 * database.
 * </p>
 * 
...
public class PlayerModelImpl extends BaseModelImpl<Player> {
	...
	public static final Object[][] TABLE_COLUMNS = { { "playerId", new Integer(Types.BIGINT) },
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps
			.get("value.object.entity.cache.enabled.com.commsen.liferay.examples.portlet.servicebuilder.model.Player"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps
			.get("value.object.finder.cache.enabled.com.commsen.liferay.examples.portlet.servicebuilder.model.Player"),
			true);
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps
			.get("lock.expiration.time.com.commsen.liferay.examples.portlet.servicebuilder.model.Player"));
	...
	public Player toEscapedModel() {
		if (isEscapedModel()) {
			...
			model = (Player) Proxy.newProxyInstance(Player.class.getClassLoader(), new Class[] { Player.class },
	...
	public ExpandoBridge getExpandoBridge() {
		if (_expandoBridge == null) {
			_expandoBridge = new ExpandoBridgeImpl(Player.class.getName(), getPrimaryKey());
		}
	...
	public String toXmlString() {
		...
		sb.append("com.commsen.liferay.examples.portlet.servicebuilder.model.Player");
		sb.append("</model-name>");

		sb.append("<column><column-name>playerId</column-name><column-value><![CDATA[");
		sb.append(getPlayerId());
		sb.append("]]></column-value></column>");
		sb.append("<column><column-name>name</column-name><column-value><![CDATA[");
		sb.append(getName());
		sb.append("]]></column-value></column>");
		sb.append("<column><column-name>active</column-name><column-value><![CDATA[");
		sb.append(getActive());
		sb.append("]]></column-value></column>");
		sb.append("<column><column-name>score</column-name><column-value><![CDATA[");
		sb.append(getScore());
		sb.append("]]></column-value></column>");
		sb.append("<column><column-name>birthday</column-name><column-value><![CDATA[");
		sb.append(getBirthday());
		sb.append("]]></column-value></column>");
